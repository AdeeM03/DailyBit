...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _signUp() async {
    setState(() {
      ...
      _passwordError = _password.length < 6 ? 'Kata sandi terlalu pendek' : null;
    });
    ...
    if (_emailError == null && _passwordError == null) {
      ...
      try {
        ...
        final credential = await authService.signUpWithEmail(_email, _password);
        if (_name.isNotEmpty && credential?.user != null) {
